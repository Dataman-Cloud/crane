    ...
    function route($stateProvider) {
        $stateProvider
            ...
            .state('registry.catalogDetail', {
                ...
                ncyBreadcrumb: {
                    label: 'Project Template Deployment'
                },
                resolve: {
                    catalog: getCatalog
                }
