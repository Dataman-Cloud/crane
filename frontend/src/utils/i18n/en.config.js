(function () {
    ...
    function i18nEn($translateProvider) {
        $translateProvider.translations('en', {
            ...
            "Chinese is not permitted": "Chinese is not permitted",
            "Chinese is not permitted": "Chinese is not permitted",
            ...
            "Create Host-Only network": "Create Host Nerwork",
            ...
            "Paused containers": "Pasued Containers",
            ...
            "Drain": "Drain",
            "Drain": "After stopping a scheduled task on that host will be assigned to other hosts , new tasks can not be allocated to the host",
            "Active": "Active",
            "Active": "Recovery tasks on this host free scheduling",
            "Pause": "Pause",
            "Pause": "After a pause dispatching a new task will no longer be assigned to the host, but the task has been released to the host will not be affected",
