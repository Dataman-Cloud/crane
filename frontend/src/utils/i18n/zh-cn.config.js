(function () {
    ...
    function i18nCn($translateProvider) {
        $translateProvider.translations('zh-CN', {
            ...
            "Chinese is not permitted": "KEY 不能包含中文",
            "Chinese is not permitted": "Value 不能包含中文",
            "Permission": "权限",
            ...
            "Drain": "停止调度",
            "Drain": "停止调度后该主机上的任务将被分配到其它主机上, 新的任务也不会被分配到该主机",
            "Active": "恢复调度",
            "Active": "恢复任务在这台主机上的自由调度",
            "Pause": "暂停调度",
            "Pause": "暂停调度后新的任务将不再被分配到该主机，但已经发布到该主机上的任务不会受到影响",
            "Delete host": "删除主机",
