...
func (a *AccountApi) CreateAccount(ctx *gin.Context) {
	...
	if err := ctx.BindJSON(&acc); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountCreateParamError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}

	if acc.Password == "" {
		rolexerr := rolexerror.NewError(CodeAccountCreateParamError, "password can not be null")
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}

	if acc.Email == "" {
		rolexerr := rolexerror.NewError(CodeAccountCreateParamError, "email can not be null")
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountCreateParamError, "invalid groupid")
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	if err := a.Authenticator.CreateAccount(groupId, &acc); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountCreateAuthenticatorError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
...
func (a *AccountApi) GetAccountInfo(ctx *gin.Context) {
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGetAccountNotFoundError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	} else {
...
func (a *AccountApi) AccountLogin(ctx *gin.Context) {
	var acc Account
	if err := ctx.BindJSON(&acc); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountLoginParamError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
...
func (a *AccountApi) AccountLogout(ctx *gin.Context) {
	if err := a.TokenStore.Del(ctx, ctx.Request.Header.Get("Authorization")); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountLogoutError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	dmgin.HttpOkResponse(ctx, "success")
...
func (a *AccountApi) GroupAccounts(ctx *gin.Context) {
	...
	if groupId, err := strconv.ParseUint(ctx.Param("group_id"), 10, 64); err != nil {
		...
		rolexerr := rolexerror.NewError(CodeAccountGroupAccountsGroupIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	} else {
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGroupAccountsNotFoundError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	} else {
		dmgin.HttpOkResponse(ctx, accounts)
	}
...
func (a *AccountApi) AccountGroups(ctx *gin.Context) {
	...
	if accountId, err := strconv.ParseUint(ctx.Param("account_id"), 10, 64); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountAccoutGroupsAccountIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	} else {
		listOptions.Filter = map[string]interface{}{
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountAccoutGroupsNotFoundError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	} else {
...
func (a *AccountApi) GetGroup(ctx *gin.Context) {
	groupId, err := strconv.ParseUint(ctx.Param("group_id"), 10, 64)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGetGroupGroupIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	group, err := a.Authenticator.Group(groupId)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGetGroupGroupIdNotFoundError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	} else {
...
func (a *AccountApi) ListGroups(ctx *gin.Context) {
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountListGroupNotFoundError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	} else {
		dmgin.HttpOkResponse(ctx, groups)
	}
...
func (a *AccountApi) CreateGroup(ctx *gin.Context) {
	if !a.Authenticator.ModificationAllowed() {
		rolexerr := rolexerror.NewError(CodeAccountAuthenticatorModificationNotAllowedError, "moditication not allowed")
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	if err := a.Authenticator.CreateGroup(&group); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountCreateGroupFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	dmgin.HttpOkResponse(ctx, "success")
...
func (a *AccountApi) UpdateGroup(ctx *gin.Context) {
	...
	if err := ctx.BindJSON(&group); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountCreateGroupParamError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}

	if err := a.Authenticator.UpdateGroup(&group); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountUpdateGroupParamError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	dmgin.HttpOkResponse(ctx, "success")
...
func (a *AccountApi) DeleteGroup(ctx *gin.Context) {
	...
	groupId, err := strconv.ParseUint(ctx.Param("group_id"), 10, 64)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountDeleteGroupGroupIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
	}

	if err := a.Authenticator.DeleteGroup(groupId); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountDeleteGroupFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
...
func (a *AccountApi) JoinGroup(ctx *gin.Context) {
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountJoinGroupGroupIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	groupId, err := strconv.ParseUint(ctx.Param("group_id"), 10, 64)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountJoinGroupAccountIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}

	if err := a.Authenticator.JoinGroup(accountId, groupId); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountJoinGroupFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
...
func (a *AccountApi) LeaveGroup(ctx *gin.Context) {
	...
	accountId, err := strconv.ParseUint(ctx.Param("account_id"), 10, 64)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountLeaveGroupAccountIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	groupId, err := strconv.ParseUint(ctx.Param("group_id"), 10, 64)
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountLeaveGroupGroupIdNotValidError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}

	if err := a.Authenticator.LeaveGroup(accountId, groupId); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountLeaveGroupFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
...
func (a *AccountApi) GrantServicePermission(ctx *gin.Context) {
	...
	if err := ctx.BindJSON(&param); err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGrantServicePermissionParamError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountGrantServicePermissionFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	dmgin.HttpOkResponse(ctx, "success")
...
func (a *AccountApi) RevokeServicePermission(ctx *gin.Context) {
	...
	if len(strings.SplitN(permission_id, "-", 2)) != 2 {
		rolexerr := rolexerror.NewError(CodeAccountRevokeServicePermissionParamError, "permission invalid")
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	...
	if err != nil {
		rolexerr := rolexerror.NewError(CodeAccountRevokeServicePermissionFailedError, err.Error())
		dmgin.HttpErrorResponse(ctx, rolexerr)
		return
	}
	dmgin.HttpOkResponse(ctx, "success")
